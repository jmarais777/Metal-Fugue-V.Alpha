...
public class TutorialBot6 : MonoBehaviour
{
    ...
    public IEnumerator Tutorial0()
    {
        ...
        Popup();
        Tutorial_Text_Label.text = "See? I told you so... Well anyways, you can press E when near these recharge stations to restore your energy.";
