...
public class Dialogue5Real : MonoBehaviour
{
    ...
    public GameObject ScavengerDialogueMenu5Object;
    public GameObject UILinker_5_real;
    ...
    private void Update()
    {
        if (ScavengerDialogueMenu5Object != null && !ScavengerDialogueMenu5Object.activeSelf)
        {
            {
                if (TransitionCondition7.activeSelf == true)
                {
                    ShowMenu1();
                }
        ...
        void ShowMenu1()
        {
            ScavengerDialogueMenu5Object.SetActive(true);
        ...
        void HideMenu1()
        {
            ...
            TransitionCondition7.SetActive(false);
