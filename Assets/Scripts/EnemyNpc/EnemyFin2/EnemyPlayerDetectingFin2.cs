...
public class EnemyPlayerDetectingFin2 : MonoBehaviour
{
    ...
    public EnemyMovementFinalFIn2 EnemyFinFin2;
    ...
    public void Update()
    {
        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFIn2.EnemyMovementType.Pathfinding2||
            EnemyFinFin2.Move_Type == EnemyMovementFinalFIn2.EnemyMovementType.Pathfinding3 )   
       

            StartCoroutine(Enemy_Patroll_Sfx());
        

        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFIn2.EnemyMovementType.Chasing)
        {
            Chasing_Light_Effect();
        }

        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFIn2.EnemyMovementType.FullDead)
        {
            DeadEffect();
        }
        ...
        if (EnemyFinFin2.isWalkingB == true)
        {
            ...
            if (EnemyFinFin2.Move_Type == EnemyMovementFinalFIn2.EnemyMovementType.Pathfinding2 && EnemyFinFin2.Move_Type == EnemyMovementFinalFIn2.EnemyMovementType.Pathfinding3)
            {
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
       ...
       if(collider.gameObject.CompareTag("Player"))
        {
        EnemyFinFin2
            .Move_Type = EnemyMovementFinalFIn2.EnemyMovementType.Chasing;
