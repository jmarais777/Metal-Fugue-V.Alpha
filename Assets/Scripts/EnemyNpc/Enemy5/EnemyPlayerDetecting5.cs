...
public class EnemyPlayerDetecting5 : MonoBehaviour
{
    public EnemyMovementFinal5 EnemyFin5; //Custom
    ...
    {
        //Custom
        if (EnemyFin5.Move_Type5 == EnemyMovementFinal5.EnemyMovementType.Pathfinding8 ||
            EnemyFin5.Move_Type5 == EnemyMovementFinal5.EnemyMovementType.Pathfinding9)
        {
            Patrolling_Light_Effect();
        }
        //Custom
        if (EnemyFin5.Move_Type5 == EnemyMovementFinal5.EnemyMovementType.Chasing)
        {
            Chasing_Light_Effect();
        }
        if (EnemyFin5.Move_Type5 == EnemyMovementFinal5.EnemyMovementType.FullDead)
        {
            DeadEffect();
        }
    }
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        {
            EnemyFin5.Move_Type5 = EnemyMovementFinal5.EnemyMovementType.Chasing; //Custom
