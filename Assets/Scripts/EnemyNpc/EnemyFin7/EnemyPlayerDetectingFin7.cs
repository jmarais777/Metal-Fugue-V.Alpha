...
public class EnemyPlayerDetectingFin7 : MonoBehaviour
{
    ...
    public EnemyMovementFinalFin7 EnemyFinFin2;
    ...
    public void Update()
    {
        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFin7.EnemyMovementType.Pathfinding2||
            EnemyFinFin2.Move_Type == EnemyMovementFinalFin7.EnemyMovementType.Pathfinding3 )   
       

            StartCoroutine(Enemy_Patroll_Sfx());
        

        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFin7.EnemyMovementType.Chasing)
        {
            Chasing_Light_Effect();
        }

        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFin7.EnemyMovementType.FullDead)
        {
            DeadEffect();
        }
        ...
        if (EnemyFinFin2.isWalkingB == true)
        {
            ...
            if (EnemyFinFin2.Move_Type == EnemyMovementFinalFin7.EnemyMovementType.Pathfinding2 && EnemyFinFin2.Move_Type == EnemyMovementFinalFin7.EnemyMovementType.Pathfinding3)
            {
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
       ...
       if(collider.gameObject.CompareTag("Player"))
        {
        EnemyFinFin2
            .Move_Type = EnemyMovementFinalFin7.EnemyMovementType.Chasing;
