...
public class EnemyPlayerDetecting2 : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (EnemyFin2.Move_Type == EnemyMovementFinal2.EnemyMovementType.Pathfinding1 ||
            EnemyFin2.Move_Type == EnemyMovementFinal2.EnemyMovementType.Pathfinding2)
        {
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        {
            EnemyFin2.Move_Type = EnemyMovementFinal2.EnemyMovementType.Chasing;
