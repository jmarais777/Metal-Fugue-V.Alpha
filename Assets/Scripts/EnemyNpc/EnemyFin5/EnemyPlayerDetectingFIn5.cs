...
public class EnemyPlayerDetectingFin5 : MonoBehaviour
{
    ...
    public EnemyMovementFinalFin5 EnemyFin;
    ...
    public void Update()
    {
        if (EnemyFin.Move_TypeFin5 == EnemyMovementFinalFin5.EnemyMovementType.Pathfinding8 ||
            EnemyFin.Move_TypeFin5 == EnemyMovementFinalFin5.EnemyMovementType.Pathfinding9 ||
            EnemyFin.Move_TypeFin5 == EnemyMovementFinalFin5.EnemyMovementType.Pathfinding10 ||
            EnemyFin.Move_TypeFin5 == EnemyMovementFinalFin5.EnemyMovementType.Pathfinding11)   
        {
            StartCoroutine(Enemy_Patroll_Sfx());
        }

        if (EnemyFin.Move_TypeFin5 == EnemyMovementFinalFin5.EnemyMovementType.Chasing)
        {
            Chasing_Light_Effect();
        }

        if (EnemyFin.Move_TypeFin5 == EnemyMovementFinalFin5.EnemyMovementType.FullDead)
        {
            DeadEffect();
        }
        ...
        if (EnemyFin.isWalkingB == true)
        {
            ...
            if (EnemyFin.Move_TypeFin5 == EnemyMovementFinalFin5.EnemyMovementType.Pathfinding8 && EnemyFin.Move_TypeFin5 == EnemyMovementFinalFin5.EnemyMovementType.Pathfinding9)
            {
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
       ...
       if(collider.gameObject.CompareTag("Player"))
        {
            EnemyFin.Move_TypeFin5 = EnemyMovementFinalFin5.EnemyMovementType.Chasing;
