...
public class EnemyPlayerDetectingFinBoss : MonoBehaviour
{
    ...
    public EnemyMovementFinalFinBoss EnemyFinFin2;
    ...
    public void Update()
    {
        ...
        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFinBoss.EnemyMovementType.Chasing)
        {
            Chasing_Light_Effect();
        }

        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFinBoss.EnemyMovementType.FullDead)
        {
            DeadEffect();
        }
        if (EnemyFinFin2.Move_Type == EnemyMovementFinalFinBoss.EnemyMovementType.SystemFailure)
        {
    ...
    public void Enemy_System_Failure2()
    {
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
       ...
       if(collider.gameObject.CompareTag("Player"))
        {
        EnemyFinFin2.Move_Type = EnemyMovementFinalFinBoss.EnemyMovementType.Chasing;
