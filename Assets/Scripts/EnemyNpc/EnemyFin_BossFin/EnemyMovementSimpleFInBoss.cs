...
public class EnemyMovementFinalFinBoss : MonoBehaviour
{
    //THE MOVEMNET STUFF
    ...
    public Enemy_Trigger_EventsFinBoss TriggEventFin2;
    public EnemyPlayerDetectingFinBoss Enemy_Player_Detetction;
    ...
    public EnemyAudiosboss AudioBoss;
