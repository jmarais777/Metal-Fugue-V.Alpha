...
public class EnemyHealth7 : MonoBehaviour
{
    ...
    public EnemyPlayerDetecting7 Enemy_Player_Detection7;
    ...
    public void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (HitPoints < 1)
        {
            Enemy_Move_Fin7.Move_Type7 = EnemyMovementFinal7.EnemyMovementType.SystemFailure; //custom
        }
    }
    ...
    IEnumerator DamageEffect()
    {
        ...
        Enemy_Player_Detection7.Chasing_Light_Effect();    //custom
    }
