...
public class EnemyMovementFinal3 : MonoBehaviour
{
    //THE MOVEMNET STUFF
    ...
    public Transform PathP4;
    public Transform PathP5;
    
    public EnemyTriggEvents3 TriggEvent3;
    public EnemyPlayerDetecting3 Enemy_Player_Detetction3;
    ...
    public EnemyMovementType Move_Type3;

    public void Start()
    {
        RigBod = GetComponent<Rigidbody2D>();
        Move_Type3 = EnemyMovementType.Pathfinding4;
    ...
    public void FixedUpdate()
    {
        ...
        switch (Move_Type3)
        {
            ...
            case EnemyMovementType.Pathfinding4: Pathfinding4(); break;
            case EnemyMovementType.Pathfinding5: Pathfinding5(); break;

        }
    }

    public void Pathfinding4()
    {
        Vector3 Dir_PathP2 = (PathP4.position - transform.position).normalized;
        RigBod.linearVelocity = (Dir_PathP2 * Pathfinding_Speed);
        Debug.Log("Pathfiding1()");
    }
    public void Pathfinding5()
    {
        Vector3 Dir_PathP2 = (PathP5.position - transform.position).normalized;
        RigBod.linearVelocity = (Dir_PathP2 * Pathfinding_Speed);
    ...
    public void System_Failure() //set in EnemyHealth Script
    {
        ...
        TriggEvent3.enabled = false;
        Enemy_Shoot_Mech.enabled = false;
        Enemy_Player_Detetction3.enabled = false;
