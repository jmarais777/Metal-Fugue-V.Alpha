...
public class EnemyPlayerDetecting3 : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        if (EnemyFin3.Move_Type3 == EnemyMovementFinal3.EnemyMovementType.Pathfinding4 ||
            EnemyFin3.Move_Type3 == EnemyMovementFinal3.EnemyMovementType.Pathfinding5)
        {
            Patrolling_Light_Effect();
        }

        if (EnemyFin3.Move_Type3 == EnemyMovementFinal3.EnemyMovementType.Chasing)
        {
            Chasing_Light_Effect();
        }
        if (EnemyFin3.Move_Type3 == EnemyMovementFinal3.EnemyMovementType.FullDead)
        {
            DeadEffect();
        }
    }
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        {
            EnemyFin3.Move_Type3 = EnemyMovementFinal3.EnemyMovementType.Chasing;
