...
public class EnemyPlayerDetecting4 : MonoBehaviour
{
    public EnemyMovementFinal4 EnemyFin4; //Custom
    ...
    {
        //Custom
        if (EnemyFin4.Move_Type4 == EnemyMovementFinal4.EnemyMovementType.Pathfinding6 ||
            EnemyFin4.Move_Type4 == EnemyMovementFinal4.EnemyMovementType.Pathfinding7)
        {
            Patrolling_Light_Effect();
        }
        //Custom
        if (EnemyFin4.Move_Type4 == EnemyMovementFinal4.EnemyMovementType.Chasing)
        {
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
        ...
        {
            EnemyFin4.Move_Type4 = EnemyMovementFinal4.EnemyMovementType.Chasing; //Custom
