...
public class EnemyMovementFinalFin1 :  MonoBehaviour
{
    //THE MOVEMNET STUFF
    ...
    public Enemy_Trigger_EventsFin1 TriggEvent;
    public EnemyPlayerDetectingFin1 Enemy_Player_Detetction;
...
public void FixedUpdate()
    ...
    public void Chasing()
    {
       ...
       PathP0.SetActive(false);
        PathP1.SetActive(false);
        Debug.Log("Chasing()");
    }
