...
public class EnemyPlayerDetectingFin3 : MonoBehaviour
{
    ...
    public EnemyMovementFinalFin3 EnemyFin;
    ...
    public void Update()
    {
        if (EnemyFin.Move_Type == EnemyMovementFinalFin3.EnemyMovementType.Pathfinding0 ||
            EnemyFin.Move_Type == EnemyMovementFinalFin3.EnemyMovementType.Pathfinding1 )   
        {
            StartCoroutine(Enemy_Patroll_Sfx());
        }

        if (EnemyFin.Move_Type == EnemyMovementFinalFin3.EnemyMovementType.Chasing)
        {
            Chasing_Light_Effect();
        }

        if (EnemyFin.Move_Type == EnemyMovementFinalFin3.EnemyMovementType.FullDead)
        {
            DeadEffect();
        }
        ...
        if (EnemyFin.isWalkingB == true)
        {
            ...
            if (EnemyFin.Move_Type == EnemyMovementFinalFin3.EnemyMovementType.Pathfinding0 && EnemyFin.Move_Type == EnemyMovementFinalFin3.EnemyMovementType.Pathfinding1)
            {
    ...
    public void OnTriggerEnter2D(Collider2D collider)
    {
       ...
       if(collider.gameObject.CompareTag("Player"))
        {
            EnemyFin.Move_Type = EnemyMovementFinalFin3.EnemyMovementType.Chasing;
